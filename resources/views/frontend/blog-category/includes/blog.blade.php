...
<div class="isotope_item vrbloglist">
    <div class="item-image">
        <a href="#"><img src="{{ \App\Facades\ViewHelperFacade::getImagePath('blog',$blog->image) }}" alt="blog" class="img-fluid"> </a>
        <span class="category-blog"> <a href="#">{{ $blog->seo_title }}</a></span>
    </div>
