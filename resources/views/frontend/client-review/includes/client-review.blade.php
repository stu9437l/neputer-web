            ...
            <div class="col-md-4 mt30">
                <div class="reviews-card pr-shadow">
                    <div class="row v-center">
                        ...
                        <div class="col"> <span class="revbx-rl"><img src="{{ \App\Facades\ViewHelperFacade::getImagePath('testimonial',$client_review->image) }}" alt="review service logo"></span> </div>
                    </div>
