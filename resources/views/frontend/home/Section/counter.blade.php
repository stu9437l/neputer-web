    ...
    <div class="container">
        <div class="row justify-content-center t-ctr">
            <div class="col-lg-4 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="@if(isset($_settings['icon1'])) {{ \App\Facades\ViewHelperFacade::getImagePath('site_configuration',$_settings['icon1']) }}@endif" alt="milestones" class="img-fluid lazy" />
                    </div>
                    <div class="statnumb">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="@if(isset($_settings['icon2'])) {{ \App\Facades\ViewHelperFacade::getImagePath('site_configuration',$_settings['icon2']) }}@endif" alt="milestones" class="img-fluid lazy" />
                    </div>
                    <div class="statnumb">
        ...
        <div class="row small t-ctr">
            <div class="col-lg-3 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="@if(isset($_settings['icon3'])) {{ \App\Facades\ViewHelperFacade::getImagePath('site_configuration',$_settings['icon3']) }}@endif" alt="milestones" class="img-fluid lazy" />
                    </div>
                    <div class="statnumb">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="@if(isset($_settings['icon5'])) {{ \App\Facades\ViewHelperFacade::getImagePath('site_configuration',$_settings['icon5']) }}@endif" alt="milestones" class="img-fluid lazy" />
                    </div>
                    <div class="statnumb">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="statistics mb0">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="@if(isset($_settings['icon6'])) {{ \App\Facades\ViewHelperFacade::getImagePath('site_configuration',$_settings['icon6']) }}@endif" alt="milestones" class="img-fluid lazy" />
                    </div>
                    <div class="statnumb">
