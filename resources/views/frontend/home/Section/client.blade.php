                    ...
                    <div class="clients-logos text-center col-12">
                        <ul class=" text-center clearfix">
                            ...
                            @forelse($data['clients'] as $client)
                                <li class="wow fadeIn " data-wow-delay="{{ $i = $i + 0.2 }}s"
                                    style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                                    <div class="clients-logo"><img
                                            data-src="{{ \App\Facades\ViewHelperFacade::getImagePath('clients', $client->image) }}"
                                            title="{{ $client->title }}"
                                            src="{{ asset('static/opacity-neputer.png') }}"
                                            alt="{{ $client->title }}" class="img-fluid lazy"></div>
                                </li>
