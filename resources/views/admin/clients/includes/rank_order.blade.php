...
@section('title', 'Client::Manage Order')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!! Form::open(['url' => route('admin.clients.sort-rank'), 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($data['clients'] as $key => $clients)
                                <tr>
                                    ...
                                    <td>
                                        <p>{{ $clients }}</p>
                                        {!! Form::hidden('clientIds[]', $key, ['class' => 'form-control']) !!}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
