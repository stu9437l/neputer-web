                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="6">
                                            <a href="{{ route('admin.clients.manage-rank') }}"
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">{!! str_limit($row->description, 30) !!}</td>
                                                <td>
                                                    <img src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('clients'), $row->image) }}"
                                                         width="150">
