                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        {{Form::open(['url' => route($base_route.('.index')), 'method'=>'get'])}}
                                                <th></th>
                                                <th>{{ Form::text('filter_role', request('filter_role') ?? null, ['class'=>'form_control']) }}</th>
                                                <th>{{ Form::text('filter_slug', request('filter_slug') ?? null, ['class'=>'form_control']) }}</th>
                                                <th>{{ Form::date('filter_created_at', request('filter_created_at') ?? null, ['class'=>'form_control']) }}</th>
                                                <th>{{ Form::date('filter_updated_at', request('filter_updated_at') ??  null, ['class'=>'form_control']) }}</th>
                                                <th>{{ Form::select('filter_status', ['all' => 'All', 'active' => 'Active', 'inactive'=>'Inactive'],request('filter_status') ?? null, ['class'=>'form_control']) }}</th>
