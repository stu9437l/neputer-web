...
@section('title', 'Slider::Manage Order')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!! Form::open(['url' => route('admin.sliders.sort-rank'), 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($data['sliders'] as $key => $sliders)
                                <tr>
                                    ...
                                    <td>
                                        <p><img src="{{ ViewHelper::getImagePath('sliders', $sliders) }}" width="200px"></p>
                                        {!! Form::hidden('sliders[]', $key, ['class' => 'form-control']) !!}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
