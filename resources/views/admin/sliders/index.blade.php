                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="6">
                                            <a href="{{ route('admin.sliders.manage-rank') }}"
                                    ...
                                    <tr>
                                        ...
                                        <th class="center">&nbsp;</th>
                                        <th></th>
                                        <th>{!! Form::text('filter_alt_text', request('filter_alt_text') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th>{!! Form::text('filter_caption', request('filter_caption') ?? null, ['class' => 'form-control']) !!}</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <img src="{{ ViewHelper::getImagePath($folder, $row->image) }}"
