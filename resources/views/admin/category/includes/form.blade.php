...
<div class="form-group">
    {!! Form::label('parent_category', 'Parent Category', ['class' => 'col-sm-3 control-label no-padding-right']); !!}
    <div class="col-sm-9">
        {!! Form::select('parent_id', $data['parentCategory']??[], null, ['placeholder' => 'Select Parent', 'class' => 'col-xs-10 col-sm-5']); !!}
    </div>
    @include('admin.include.form_validation_message', ['field' => 'parent_id'])
</div>
...
@if (isset($data['row']))
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            @if ($data['row']->banner)
                <img src="{{ ViewHelper::getImagePath($folder, $data['row']->banner) }}" width="500">
            @else
                <p>No Image</p>
            @endif
        </div>
...
<div class="form-group">
    {!! Form::label('image', 'Banner_image', ['class' => 'col-sm-3 control-label no-padding-right']); !!}
    <div class="col-sm-9">
