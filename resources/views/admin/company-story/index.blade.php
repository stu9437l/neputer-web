...
@section('title', 'Company Story::List')
                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="center">&nbsp;</th>
                                        <th>{!! Form::text('filter_year', request('filter_year') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th>{!! Form::text('filter_description', request('filter_description') ?? null, ['class' => 'form-control']) !!}</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">{{$row->year}}</td>
                                                <td class="hidden-480">{!! str_limit($row->detail, 30) !!}</td>
