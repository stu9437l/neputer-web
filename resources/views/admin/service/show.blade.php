                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>Image</td>
                                        <td><img src="{{ ViewHelper::getImagePath($folder, $data['row']->image) }}"
                                                 width="300"></td>
                                    </tr>

                                    <tr>
                                        <td>Expertise Title</td>
                                        <td>{{ $data['row']->expertise_title }}</td>
                                    </tr>
                                    <tr>
                                        <td>Expertise Description</td>
                                        <td>{!! $data['row']->expertise_detail !!}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $data['row']->seo_desc !!}</td>
                                    </tr>
                                    <tr>
                                        <td>Seo Keyword</td>
                                        <td>{!! $data['row']->seo_keywords !!}</td>
                                    </tr>
                                    <tr>
                                        <th>Created At</th>
