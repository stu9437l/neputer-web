                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>&nbsp;</th>
                                        <th>{!! Form::text('filter_expertise_title', request('filter_expertise_title') ?? null, ['class' => 'form-control']) !!}</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('services'), $row->image) }}"
                                                         width="150">
                                                </td>
