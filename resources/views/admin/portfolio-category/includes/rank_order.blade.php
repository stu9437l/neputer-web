...
@section('title', 'Portfolio Category::Manage Order')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!! Form::open(['url' => route('admin.blogCategory.sort-rank'), 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                    <div class="table-responsive">
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($data['blogCategories'] as $key => $blogCategory)
                                <tr>
                                    <td class="center">
                                        <label>
                                            <i class="icon-sort"></i>
                                    ...
                                    <td>
                                        <p>{{ $blogCategory }}</p>
                                        {!! Form::hidden('blogCategoryIds[]', $key, ['class' => 'form-control']) !!}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
