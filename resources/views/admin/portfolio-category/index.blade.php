                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{!! Form::text('filter_slug', request('filter_slug') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th>&nbsp;</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('portfolio_category'), $row->image) }}"
                                                         width="150">
