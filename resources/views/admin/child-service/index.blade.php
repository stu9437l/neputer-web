...
@section('title', 'Child Service::List')
                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{!! Form::text('filter_service_title', request('filter_service_title') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th>&nbsp;</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">{{$row->service_title}}</td>
                                                <td>
                                                    <img src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('child_service'), $row->image) }}"
                                                         width="150">
                                                </td>
