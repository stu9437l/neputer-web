                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{!! Form::text('filter_icon', request('filter_icon') ?? null, ['class' => 'form-control']) !!}</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480"><img
                                                            src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('technology'), $row->icon) }}"
                                                            width="150"></td>
