...
@section('title', 'Technologies::Edit')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data', 'id' => 'technology-form']) !!}
...
@section('js_scripts')
    ...
    @include('admin.technologies.includes.scripts')
@endsection
