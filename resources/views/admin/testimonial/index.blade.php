                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th colspan="3">
                                            <div class="widget-main">
                                                {{Form::open(['url' => route($base_route.'.bulk-action'), 'id' => 'bulk-action-form', 'method'=>'post'])}}
                                    ...
                                    <tr>
                                        ...
                                        <th class="center">&nbsp;</th>
                                        <th>{!! Form::text('filter_testimonial_by', request('filter_testimonial_by') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th></th>
                                        <th>{!! Form::text('filter_designation', request('filter_designation') ?? null, ['class' => 'form-control']) !!}</th>
                                        ...
                                        <th>{!! Form::select('filter_status', ['all' => 'All', 'active' => 'Active', 'inactive' => 'Inactive'], request('filter_status') ?? null, ['class' => 'form-control']) !!}</th>
                                        <th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        @foreach($data['rows'] as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ ViewHelper::getImagePath(AppHelper::getFolderName('testimonial'), $row->image) }}"
                                                         width="150">
                                                </td>
