...
@section('title', 'Testimonial Manage Order')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!! Form::open(['url' => route('admin.testimonial.sort-rank'), 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($data['testimonials'] as $key => $testimonial)
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <img src="{{ ViewHelper::getImagePath('testimonial', $testimonial->image) }}"
                                                 width="100"></p>
                                        {!! Form::hidden('testimonial[]', $testimonial->id, ['class' => 'form-control']) !!}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
